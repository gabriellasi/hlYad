...
<html lang="he" dir="rtl">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="shelterList.css"> 
    ...
    <body>
        <div class="container">
            ...
            <a href="http://gabriellasi.mtacloud.co.il/Shelters%20list/shelterList.php" onclick="signOut();" id="signOut" style="display:none;"> התנתק</a>
            <script>
                function signOut() {
                    gapi.auth2.init();
