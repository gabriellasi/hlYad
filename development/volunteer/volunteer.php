...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="newVolunteer.css">
    ...
    <body dir="rtl">
        <div class="container">
            ...
            <a href="http://gabriellasi.mtacloud.co.il/new%20volunteer/volunteer.php" onclick="signOut();" id="signOut" style="display:none;"> התנתק</a>
            <script>
                function signOut() {
                    gapi.auth2.init();
        ...
        <main>
            ...
            <div class="form">
                ...
                <form action="newVolunteer.php" dir="rtl" method="post" id="join" onsubmit="getCity()">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="firstName" name="firstName" placeholder="שם פרטי"
                        required pattern="(?=.*[\u0590-\u05FF]).{2,}" 
                        title="אנא הכנס/י שם פרטי בעברית המכיל לפחות 2 תווים" 
                        oninvalid="setCustomValidity('אנא הכנס/י שם פרטי בעברית המכיל לפחות 2 תווים');"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="lastName" name="lastName" placeholder="שם משפחה"
                         title="אנא הכנס/י שם משפחה בעברית המכיל לפחות 2 תווים"
                        required pattern="(?=.*[\u0590-\u05FF]).{2,}"
                        oninvalid="setCustomValidity('אנא הכנס/י שם משפחה בעברית המכיל לפחות 2 תווים');"
                        onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"
                       />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="street" name="street" placeholder="רחוב" required title="אנא הכנס/י שם רחוב המכיל לפחות 2 תווים" pattern="(?=.*[\u0590-\u05FF]).{2,}"
                        oninvalid="setCustomValidity('אנא הכנס/י רחוב המכיל לפחות 2 תווים')"
                          onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"
                       />
                    </div>
                     <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="כתובת מייל" required title="בבקשה הכנס/י '@' בכתובת המייל שלך" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="riskType" name="riskType" required oninvalid="setCustomValidity('אנא בחר/י תחום סיכון')"
                          onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"
                      >
