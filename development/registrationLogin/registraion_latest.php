  ...
  <head>
    ...
    <body>
        <div class="container">
            ...
            <a href="http://gabriellasi.mtacloud.co.il/registrationLogin/registraion_latest.php" id="signOut" onclick="signOut();" >התנתק</a>
                ...
                <div calss="navbar">
                    <nav class="stroke">
                        <ul>
                          ...
                          <li><a href="http://gabriellasi.mtacloud.co.il/PersonalErea/personalPage_Trial.php" id="personalAreaLink" style="display:none;" target="_blank">איזור אישי</a></li>
                          <li><a href="http://gabriellasi.mtacloud.co.il/contact%20us/contactPage.php">יצירת קשר</a></li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 login">
                        ...
                        <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phoneNum" placeholder="הכנס/י את מספר הטלפון של בית המחסה" required pattern="^[0-9]{9,11}$" title="אנא הכנס/י מספר טלפון המכיל 9-11 ספרות"
                       ...
                       />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="age" placeholder="גיל" value="" required oninvalid="setCustomValidity('אנא הכנס/י גיל בין 8 ל-30')" onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');" min="8" max="30">
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" required oninvalid="setCustomValidity('אנא בחר אפשרות מהרשימה')" onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');">
...
*/
        ...
        <script>
            function refreshPage(){
                window.location.reload();
                location.href='http://gabriellasi.mtacloud.co.il/registrationLogin/registraion_latest.php';
            }
        </script>
        <script>
                function homePage(){
        ...
        <script>
            ...
            document.getElementById("registrationForm").reset();
             location.href='http://gabriellasi.mtacloud.co.il/PersonalErea/personalPage.php';
            }
        </script>
        <script>
