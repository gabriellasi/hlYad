...
<html lang="en">
	...
	<link rel="stylesheet" type="text/css" href="newSupportGroup.css"> 
    ...
    <body dir="rtl">
        <div class="container">
            ...
            <a href="http://gabriellasi.mtacloud.co.il/new%20support%20group/supportGroup.php" onclick="signOut();" id="signOut" style="display:none;"> התנתק</a>
            <script>
                function signOut() {
                    gapi.auth2.init();
        ...
        <main>
            ...
            <div class="form">
                ...
                <form action="newSupportGroup.php" dir="rtl" method="post" id="join" onsubmit="getCity()">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="supportGroupName" name="supportGroupName" placeholder=" שם קבוצת התמיכה"
                         title="בבקשה הכנס/י את שם בית המחסה"
                        required pattern="(?=.*[\u0590-\u05FF]).{2,}"
                    ...
                    <div class="form-group">
                        ...
                        <label for="supportGroupManager">
                            שם מנהל קבוצת התמיכה:
                        </label>
                        <input type="text" class="form-control" id="supportGroupManager" name="supportGroupManager" placeholder=" שם מנהל קבוצת התמיכה"
                        required title="אנא מלא/י שדה זה"
                          pattern="(?=.*[\u0590-\u05FF]).{2,}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="street" name="street" placeholder=" רחוב קבוצת התמיכה"
                        required title="בבקשה מלא/י שדה זה"
                        pattern="(?=.*[\u0590-\u05FF]).{2,}"
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="כתובת המייל של קבוצת התמיכה " required title="בבקשה הכנס/י '@' בכתובת המייל שלך" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
                        oninvalid="setCustomValidity('כתובת מייל לא תקינה. בבקשה הכנס @ בכתובת המייל שלך')"
                        onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : '');"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="riskType" name="riskType" required oninvalid="setCustomValidity('יש למלא שדה זה')"
                    ...
                    <input type="hidden" id="cityChange" name="cityName" value="" required>
                    
                    <input type="submit" class="btn btn-info btn-lg" value="הצטרף"  >
